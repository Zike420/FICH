...
create table persona.auditoria_cliente (
	id bigint not null default nextval('persona.persona_sequence'),
	fecha date not null,
	operacion varchar(10) not null,
	id_cliente bigint not null,
	CONSTRAINT auditoria_cliente_pk PRIMARY KEY (id)
	--CONSTRAINT auditoria_cliente_fk FOREIGN KEY (id_cliente) REFERENCES persona.cliente (id)
);
